var app = new Vue({
    ...
    data: {
        services: [
            ...
            ["Treatment & fertilization", 0.003, "/ Square Foot (typically 3x / year)", 0],
            ["Lawn Thatching / Clean up", 0.004, "/ Square Foot (typically done weekly)", 0],
            ...
            ["Tree-health inspection", 5, "/ Tree", 0],
